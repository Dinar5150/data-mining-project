...
The second data mining goal is supervised prediction of \texttt{review\_concern}. The model receives pull-request-intrinsic information from the enriched record, including metadata, changed-file summaries, and capped code-diff embeddings. Review-derived variables are excluded from the feature matrix. The model predicts whether review activity contains a substantive concern signal, defined by a \texttt{CHANGES\_REQUESTED} review or at least two meaningful review comments.
